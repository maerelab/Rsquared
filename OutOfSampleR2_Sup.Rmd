...
```{r covMSEMST, eval = FALSE, fig.cap = '\\label{fig:covMSEMST}Scatterplot of MST estimates vs MSE estimates on 5,000 independent test datasets under the null hypothesis in the one-dimensional scenario. The title shows the correlation.', fig.width = 4}
